...
public class OpenWRTInstallBuilder extends Builder implements SimpleBuildStep
{
    ...
    throws InterruptedException, IOException 
    {
        ...
        logger.printf("%s - [INFO] ====== Installation Builder ======%n", DateTime.now().toString(DateTime.FORMAT_ISO_MS));
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> 
    {
        ...
        {
            return Messages.DemeterInstallBuilder_DescriptorImpl_DisplayName();
        }        
    }
}
